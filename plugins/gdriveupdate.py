...
class GoogleDriveSizeCalculate:
    ...
    async def gdrive_checker(self, LINKorID):
    ...
    async list_drive_dir(self, file_id: str) -> list:
    ...
    async def gDrive_file(self, **kwargs):
        try:
    ...
    async def gDrive_directory(self, **kwargs) -> None:
